  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <div className="mb-8">
          <h1 className="font-heading text-7xl md:text-8xl lg:text-9xl font-bold uppercase leading-[0.9] tracking-tight mb-4">
        ...
        <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold uppercase leading-[0.9] tracking-tight mb-8">
          Find.
          <br />
          Compare.
          <br />
